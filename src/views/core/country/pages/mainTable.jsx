...
const headCells = [
  ...
  { id: 'companyInformaiton ', numeric: true, disablePadding: true, label: 'Company Informations' },
  { id: 'contactInformaiton ', numeric: true, disablePadding: true, label: 'Contact Informations' },
  { id: 'actions ', numeric: true, disablePadding: true, label: 'Actions   D/E' },
];
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete">
          <IconButton aria-label="delete">
             <DeleteIcon onClick={()=>{
               axios.post("https://localhost:5001/api/country/MultipleRowDelete/",props.selected).then(res=>{
...
//////////////////////////Pagination
  ...
  const getAll = (page,pageSize) => {
    return  axios.get("https://localhost:5001/api/country/getPaginated/"+page+"/"+pageSize);
  };
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.companyContactsInformationsCount}</TableCell>
                      <TableCell align="right">{row.contactInformationsCount}</TableCell>
                      <TableCell>
