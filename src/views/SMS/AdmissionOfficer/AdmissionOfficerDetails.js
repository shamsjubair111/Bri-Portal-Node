      ...
      <div className="row">
        <div className="col-md-9 col-sm-12">
          ...
          <CardBody>
              ...
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12 left-adm-div">
                  ...
                  <div className="adm-user-img">
                   {
                    (officerObj?.admissionOfficerMedia?.thumbnailUrl == null) ? 

                    <img src={user} alt='admission_manager_media' />
                    :
                     <img src={rootUrl + officerObj?.admissionOfficerMedia?.thumbnailUrl} alt='admission_manager_media' />
                   }
               ...
               <span className="edit1-adm"  onClick={updateProfilePic}><i className="fas fa-camera" style={{cursor: "pointer"}} > </i ></span>
                ...
                null
                  ...
                  <div className="adm-manager-user-info ml-md-5 ml-ms-0">
                    <p className="adm-user-title">{officerObj?.nameTittleName} {officerObj?.firstName} {}{" "}
                  {officerObj?.lastName}{" "}</p>

                  <p><span className="adm-provider-css">Provider: </span><span className="adm-provider-css-name" onClick={()=>{
                    history.push(`/providerDetails/${officerObj?.providerId}`)
                  }}>{officerObj?.providerName}</span></p>
                  </div>
              ...
              <div className="mb-1">
              <span className="adm-provider-css-name2">{officerObj?.email}</span>
              </div>
                  
                 <div className="mb-1">
                 <span className="adm-provider-css-name2">{officerObj?.phoneNumber}</span>
                 </div>
                
                  <div className="mb-1">
                  <span className="adm-provider-css">{officerObj?.stateName}</span>
                  </div>
                  </div>
              ...
              <div
                ...
                <div className="d-flex justify-content-between mt-4">
                  <div>
                  {
                    ...
                    <span onClick={()=>handlRedirectToAdmissionManagerDetails(manager)}>
                      {manager?.nameTittleName} {manager?.firstName}{" "}
                      {manager?.lastName}
                    </span>
                    </div>
