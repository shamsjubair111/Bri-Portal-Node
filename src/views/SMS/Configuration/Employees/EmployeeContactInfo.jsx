...
const EmployeeContactInfo = () => {
    ...
    useEffect(()=>{
        ...
        get(`EmployeeContactInformation/GetByEmployeeId/${id}`)
        .then(res => {
    ...
    const handleSubmit = (event) => {
        ...
        for (var value of subData.values()) {
            ...
            const returnValue = put(`EmployeeContactInformation/Update`,subData).then((action)=> {
                console.log(action);
            ...
            <Card>
              <CardHeader className="page-header">
                  ...
                  <div className="page-header-back-to-home">
                    <span onClick={backToDashboard}> <i className="fas fa-arrow-circle-left"></i> Back to Staff List</span>
                  </div>
