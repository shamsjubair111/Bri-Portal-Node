...
const ConvertStudentIntoConsultantForm = () => {
  ...
  const handleSubmit  = (event) => {
    ...
    if(FileList.length <1){
        ...
        post(`BecomeConsultant/Submit`,subData)
        .then(res => {
                  ...
                  <div className='row'>
                    <div className='col-md-9'>
                        <div className='d-flex justify-content-end'>
                            <Button color='danger' className='mr-1' onClick={backToDashboard}>Cancel</Button>

                            <Button color='primary' className='ml-1' disabled={buttonStatus}>Submit</Button>
                        </div>
