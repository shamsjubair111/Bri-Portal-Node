...
const AddEducationLevel = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if(name !== undefined && description !== undefined && levelValue !== undefined && id !== undefined){

          put(`EducationLevel/Update`,subData)
          .then(res => {
        ...
        post(`EducationLevel/Create`,subData)
        .then(res => {
           if(res?.status ==200 && res?.data?.isSuccess == true){
             addToast(res?.data?.message,{
                appearance: 'success',
    ...
    <Card className="uapp-card-bg">
        <CardHeader className="page-header">
          <h3 className="text-light">Add Education Level</h3>
      ...
      <Card>
        <CardBody>
              ...
              <Form onSubmit={handleSubmit}  className="mt-5">
                ...
                {
                  (name !== undefined && description !== undefined && levelValue !== undefined && id !== undefined) ?
                  <input
                  type='hidden'
                  name='id'
                  id='id'
              ...
              <FormGroup row className="has-icon-left position-relative">
                ...
                <Col md="6">
                 ...
                 <Input type="textarea" name="description" id="description" rows={8}
