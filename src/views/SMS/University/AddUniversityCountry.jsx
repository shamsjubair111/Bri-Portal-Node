        ...
        <CardBody>
          ...
          <thead className="thead-uapp-bg">
            ...
            <tbody>
              ...
              {
                univerSityCountries?.map((uniCountry, i) => <tr key={uniCountry.id} style={{ textAlign: "center" }}>
                  <th scope="row">{i + 1}</th>
                  ...
                  <td>
                    ...
                    <Modal isOpen={deleteModal} toggle={closeDeleteModal} className="uapp-modal">
                      ...
                      <ModalFooter>
                        <Button color="danger" onClick={() => handleDeleteUniCountry(localStorage.getItem('delUniCountryId'))}>YES</Button>
