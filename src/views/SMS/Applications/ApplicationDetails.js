...
const ApplicationDetails = () => {
  ...
  const handleChange = (uId) => {
    setModalOpen(true);
    get(`AdmissionManagerDD/University/${uId}`)
    .then(res => {
  ...
  const handleChange1 = (uId) => {
    setModalOpen1(true);
    get(`AdmissionOfficerDD/University/${uId}`)
    .then(res => {
      setOfficerDD(res);
    })
  }
  ...
  const handleSubmitChange = (e) =>{
    ...
    if(managerValue === 0){
      ...
      setProgress1(true);
      put(`ApplicationAdmissionManager/ChangeAdmissionManager/${id}/${managerValue}`).then((res) => {
  ...
  const handleSubmitChange1 = (e) =>{
    ...
    if(officerValue === 0){
      ...
      setProgress2(true);
      put(`ApplicationAdmissionOfficer/ChangeAdmissionOfficer/${id}/${officerValue}`).then((res) => {
            ...
            <CardBody>
              <div className="hedding-titel d-flex justify-content-between mb-3">
                ...
                <div className="text-right edit-style">
                 ...
                 {
                   userType == userTypes?.SystemAdmin || userType == userTypes?.Admin || userType == userTypes?.ProviderAdmin ?
                   <ButtonForFunction
              ...
              <Modal isOpen={modalOpen1} toggle={closeModal1} className="uapp-modal">
                ...
                <Form onSubmit={handleSubmitChange1}>
                  ...
                  {/* {
                    ...
                    />
                      ...
                      <FormGroup row className="has-icon-left position-relative">
                        <Col md="4">
                          <span>Admission Officer <span className="text-danger">*</span>{" "}</span>
                        </Col>
                        <Col md="8">
                        <Select
                  ...
                  <FormGroup className="has-icon-left position-relative" style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Button color="danger" className="mr-1 mt-3" onClick={closeModal1}>Close</Button>
...

                {
                  ...
                  <div className="d-flex justify-content-between">
                    <div className="my-auto">
                      <span>
                        <b>Name:</b> {applicationInfo?.admissionOfficer?.firstName}{" "}
                        {applicationInfo?.admissionOfficer?.lastName}
                      </span>{" "}
                      <br />
                      <span>
                        <b>Email:</b> {applicationInfo?.admissionOfficer?.email}
                      </span>
                      <br />
                      <span>
                        <b>Phone:</b>{" "}
