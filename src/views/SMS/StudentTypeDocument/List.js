  ...
  const closeDeleteModal = () => {
    ...
    setDeleteModal(false);
      ...
      const handleDeleteDocumentGroup = () =>{
        ...
        setProgress2(true);
        remove(`StudentTypeDocument/Delete/${delData?.id}`)
        .then(res => {
      ...
      const handleSubmit  =(e) =>{
        ...
        if(docValue == 0 ){
            ...
            setProgress1(true);
            post(`StudentTypeDocument/Create`,subData)
            .then(res => {
    ...
    return (
       ...
       <div>
        {
              permissions?.includes(permissionList.Add_New_Student_Type_Documents) ?
              <ButtonForFunction
                  ...
                  <ModalBody>
                    <Form onSubmit={handleSubmit}>
                      ...
                      <FormGroup
                              ...
                              >
                                <Col md="4">
                                  <span>Mandatory {''}<span className='text-danger'>*</span></span>
                                </Col>
                                <Col md="8">
                      ...
                      <tr key={doc?.id} style={{ textAlign: "center" }}>
                        ...
                        <td>
                          <ButtonGroup>
                           ...
                           {
                            permissions?.includes(permissionList.Delete_Student_Type_Documents) ?
                            <ButtonForFunction
