...
{
  permissions?.includes(permissionList.Change_Provider_Admin_profileImage) ?
      ...
      <FormGroup row>
        ...
        <Card>  
          ...
          <div className="adm-user-img">
          {
            ...
            <>
            {
            (data?.providerAdminMedia?.thumbnailUrl == null) ?
            <img src={rootUrl + data?.providerAdminMedia?.fileUrl} alt='provider_admin_media' />
            :
            <img src={rootUrl + data?.providerAdminMedia?.thumbnailUrl} alt='provider_admin_media' />
          }
            </>
          ...
          <div className="adm-manager-user-info ml-md-5 ml-ms-0">
            <p className="adm-user-title">{data?.nameTittle?.name}{' '}{data?.firstName}{" "}{data?.lastName}{" "}</p>

          <p><span className="adm-provider-css">Provider: </span><span className="adm-provider-css-name" onClick={()=> {
            history.push(`/branchProfile/${data?.providerId}`)
          }}>{data?.providerName}</span></p>
          </div>
          ...
          <div className="mb-1">
          <span className="adm-provider-css-name2">{data?.email}</span>
          </div>

          <div className="mb-1">
          <span className="adm-provider-css-name2">{data?.phoneNumber}</span>
          </div>
