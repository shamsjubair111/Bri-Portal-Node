            ...
            <div className="col-md-3 col-sm-0">
            {
                ...
                >
                  ...
                  <h5 className="pb-2">
                      ...
                      <span>
                      {managerData?.branch?.name}{" "}
                      <br/>
                      {managerData?.branch?.branchCode}{" "}
                      <br/>
                ...
                <CardBody>
                  <div>
                    <ul className="uapp-ul text-center">
                      ...
                      <li> <b>{managerData?.branch?.phoneNumber}</b> </li>
                      <li> <i className="far fa-envelope"></i>{" "}{managerData?.branch?.addressLine} </li>
