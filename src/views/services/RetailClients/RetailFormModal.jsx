...
import RetailClientInformationForm from "./RetailClientInformationForm/RetailClientInformationForm";

const RetailFormModal = ({
  editMode,
  handleCloseModal,
  handleSubmit,
  handleChange,
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
            {editMode.type === "UPDATE" ? "Update Client" : "Add Retail Client"}
          </Typography>
...
export default RetailFormModal;
