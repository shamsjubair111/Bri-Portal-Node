                        ...
                        >
                          ...
                          <Col md="6">
                            <Input
                              ...
                              id="ieltsEquivalent"
                              defaultValue={
                                updateToefl ? toefl?.ieltsEquivalent : ""
                              }
                              min="0"
                            />
                          </Col>
                        ...
                        >
                          ...
                          <Col md="6">
                            <Input
                              ...
                              id="ieltsEquivalent"
                              defaultValue={
                                updateGcse ? gcse?.ieltsEquivalent : ""
                              }
                              min="0"
                            />
                          </Col>
                  ...
                  <Card className="CampusCard test-score-card-style">
                    ...
                    >
                      ...
                      <ModalFooter>
                        <Button
                          color="danger"
                          onClick={deleteEnglishTestScore}
              ...
              {duolingo?.id ? (
                <div className="col-md-6 mt-2" style={{ textAlign: "left" }}>
                  <Card className="CampusCard test-score-card-style">
                    <CardBody className="shadow">
                      <div className="d-flex justify-content-space-between">
                        <h5 className="test-score-title-style">
                          DUOLINGO Score
                        </h5>
                        <div className="CampusCardAction">
                          <div className="">
                    ...
                    <Card className="CampusCard shadow-style test-score-card-style">
                      <CardBody className="shadow">
                        ...
                        <div className="d-flex justify-content-between">
                          <div>
                            <span className="bank-account-info-text">
                              Quantitative Score: {greData?.quantitativeScore}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Quantitative Rank: {greData?.quantitativeRank}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Verbal Score: {greData?.verbalScore}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Verbal Rank: {greData?.verbalRank}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Writing Score: {greData?.writingScore}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Writing Rank: {greData?.writingRank}
                            </span>
                            <br />
                          </div>
                    ...
                    <Card className="CampusCard shadow-style test-score-card-style">
                      <CardBody className="shadow">
                        ...
                        <div className="d-flex justify-content-between">
                          <div>
                            <span className="bank-account-info-text">
                              Quantitative Score: {gmatData?.quantitativeScore}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Quantitative Rank: {gmatData?.quantitativeRank}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Verbal Score: {gmatData?.verbalScore}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Verbal Rank: {gmatData?.verbalRank}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Total Score: {gmatData?.totalScore}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Total Rank: {gmatData?.totalRank}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Writing Score: {gmatData?.writingScore}
                            </span>
                            <br />
                            <span className="bank-account-info-text">
                              Writing Rank: {gmatData?.writingRank}
                            </span>
                            <br />
                          </div>
                          <div>
