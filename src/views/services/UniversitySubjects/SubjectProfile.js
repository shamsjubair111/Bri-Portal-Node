            ...
            <div className="page-header-back-to-home">
              <span onClick={backToSubjectList} className="text-white">
                ...
                {location?.campId != undefined
                  ? "Back to Campus Subject List"
                  : location.uniSubList != undefined ||
                    location.unnniId != undefined
                    ...
                    {userType == userTypes?.Student ? null : (
                      <Col>
                        {permissions?.includes(
                          permissionList?.Add_New_subject
                        ) ||
                        permissions?.includes(
                    ...
                    <Col md="6">
                      <ul className="uapp-ul text-left">
                        <li>
                          <span>
                            {" "}
                            Program : {subjectData?.programLevel?.name}{" "}
                          </span>
                        </li>
                  ...
                  <Table className="table-bordered mt-4">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td width="60%">{subjectData?.programLevel?.name}</td>
                      </tr>
                          ...
                          {subjectData?.subjectRequireDocuments?.map(
                            (sub, i) => (
                              <tr key={i} style={{ textAlign: "center" }}>
                                ...
                                <td>{sub?.documentGroup?.details}</td>
                                <td>
