                  ...
                  <thead className="thead-uapp-bg">
                    <tr style={{ textAlign: "center" }}>
                      ...
                      {permissions?.includes(
                        permissionList.View_Document_Group_info
                      ) ? (
                        <th>Documents</th>
                      ) : null}
                      <th>Action</th>
                    ...
                    {documentGroupData?.map((document, i) => (
                      <tr key={document?.id} style={{ textAlign: "center" }}>
                        ...
                        <td>
                          <ButtonGroup>
                            {permissions?.includes(
                              permissionList.Update_Document_Group_info
                            ) ? (
                              <ButtonForFunction
                            ...
                            {permissions?.includes(
                              permissionList.Delete_Document_Group
                            ) ? (
                              <ButtonForFunction
                                className={"mx-1 btn-sm"}
                                func={() =>
                          ...
                          >
                            <ModalBody>
                              <p>
                                ...
                                <b>{delDocuGroupName}</b> ? Once Deleted it
                                can't be Undone!
                              </p>
                            </ModalBody>
