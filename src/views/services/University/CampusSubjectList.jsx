          ...
          {campus?.name != undefined ? (
            <div className="test-score-div-1-style mt-1 mb-4">
              <span className="test-score-span-1-style">
                Showing subject list of <b>{campus?.name}</b>{" "}
              </span>
            </div>
          ) : null}
          ...
          <Row className="mb-3">
            <Col lg="5" md="5" sm="12" xs="12">
              {permissions?.includes(
                permissionList.Add_New_university_campus_subject
              ) ? (
                <ButtonForFunction
              ...
              <Table id="table-to-xls" className="table-sm table-bordered">
                <thead className="thead-uapp-bg">
                  <tr style={{ textAlign: "center" }}>
                    ...
                    {permissions?.includes(
                      permissionList.View_subject_intake_List
                    ) ? (
                      ...
                      {checkAction ? (
                        <td style={{ width: "8%" }} className="text-center">
                          <ButtonGroup variant="text">
                            ...
                            {permissions?.includes(
                              permissionList.View_university_campus_subject_info
                            ) ? (
                              <ButtonForFunction
                          ...
                          /> */}
                            {permissions?.includes(
                              permissionList.Update_university_campus_subject_info
                            ) ? (
                              <ButtonForFunction
                                func={() => toggleEdit(sub)}
                                color={"warning"}
                            ...
                            {permissions?.includes(
                              permissionList.Delete_university_campus_subject
                            ) ? (
                              <ButtonForFunction
                                func={() =>
