      ...
      <div className=" info-item mt-4">
        <Card className="uapp-employee-search">
          <CardBody className="search-card-body">
            ...
            <div className="container test-score-div-1-style mt-1 mb-4">
              <div className="d-flex justify-content-between">
                <span className="test-score-span-1-style my-auto">
                  Assign all subjects on this campus with all application types.
                  [Is not recommended]
                </span>
            ...
            >
              <ModalBody>
                <p>Are You Sure to Assign All Subjects?</p>
              </ModalBody>
                ...
                <div>
                  ...
                  <div>
                    <span className="text-danger">
                      N.B : Select the checkboxes of a particular subject only.
                    </span>
                  </div>
                </div>
              </span>
