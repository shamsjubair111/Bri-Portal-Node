...
const Search = () => {
  ...
  const checkEligibility = (data1, data2) => {
    ...
    get(
      `Eligibility/CheckEligibility/${data1?.universityId}/${
        data2?.subjectId
      }/${localStorage.getItem("referenceId")}`
    ).then((res) => {
      setElAns(res);
              ...
              <div className="col-md-6">
                ...
                <div className="mt-3">
                  <span style={{ fontSize: "14px", fontWeight: "500" }}>
                    IELTS: {elStatus?.ieltsMessage}
                  </span>
                  <br />
                  <span style={{ fontSize: "14px", fontWeight: "500" }}>
                    Level Requirement: {elStatus?.requiredEducationlevel}
                  </span>
                  <br />
                  <span style={{ fontSize: "14px", fontWeight: "500" }}>
                  ...
                  <FormGroup row className="has-icon-left position-relative">
                    ...
                    <Col md="9">
                      <Select
                        ...
                        id="providerTypeId"
                        onChange={(opt) =>
                          selectModalIntake(opt.label, opt.value)
                        }
                      />
                      {intakeError ? (
                        <span className="text-danger">
                  ...
                  <FormGroup row className="has-icon-left position-relative">
                    ...
                    <Col md="9">
                      <Select
                        ...
                        id="providerTypeId"
                        onChange={(opt) =>
                          selectModalDelivery(opt.label, opt.value)
                        }
                      />
                      {deliveryError ? (
                        <span className="text-danger">
                ...
                <Card>
                  <CardBody>
                    ...
                    <Select
                      ...
                      id="providerTypeId"
                      onChange={(opt) =>
                        selectUniversityType(opt.label, opt.value)
                      }
                    />
                        ...
                        <div key={i}>
                          <Card className="p-2">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                <div className="">
                                  <Link
                                    to={`/universityDetails/${info?.universityId}`}
                                  >
                                    <span className="university-title-style">
                                      {info?.name}
                                    </span>
                                  </Link>
                                  <br />
                          ...
                          {info?.subjects?.length < 1 ? (
                            <div className="text-center mb-2">
                              <span className="nodata-found-style">
                                No programs found
                              </span>
                            </div>
                          ) : (
                                    ...
                                    .map((subjectInfo, i) => (
                                      <div className="row my-3" key={i}>
                                        <div className="col-md-12 border-left-style-searchPage">
                                          ...
                                          >
                                            <span className="course-name-style">
                                              {subjectInfo?.title}
                                            </span>
                                          </Link>
                                          <br />
                                          ...
                                          <div className="row my-1">
                                            <div className="col-md-10">
                                              ...
                                              {subjectInfo?.campuses?.map(
                                                (camp, i) => (
                                                  <span
                                                    className="btn-customStyle-1 ms-2"
                                                    key={i}
                                                  >
                                                    {camp?.campusName}
                                                  </span>
                                              ...
                                              userTypes?.Student ? (
                                                <>
                                                  {permissions?.includes(
                                                    permissionList.Add_New_Wish_List
                                                  ) ? (
                                                    <ComponentButton
                                                      func={() =>
                                                        addToWishList(
                                          ...
                                          <div className="row">
                                            <div className="col-md-3">
                                              <span className="p-style-1">
                                                Tution fee
                                              </span>
                                              {showLocal ? (
                                                <>
                                                  <br />
                                                  <span className="p-style-2">
                                                    Local -{" "}
                                            ...
                                            {subjectInfo?.canApply ? (
                                              <div className="col-md-2">
                                                <div>
                                                  <div className="mb-2">
                                                    {permissions?.includes(
                                                      ...
                                                      <CustomLinkButton
                                                        ...
                                                        target={"_blank"}
                                                        className={
                                                          "button2-style-search me-1 (userType == userTypes?.Student)? w-75 : null  "
                                                        }
                                                        icon={
                                                  ...
                                                  {permissions?.includes(
                                                    permissionList.Add_Application
                                                  ) ? (
                                                    <button
                                                      className="button-style-search (userType == userTypes?.Student)? w-75 : null "
                                                      onClick={() =>
                                                        toggleModal(
                                                          subjectInfo,
                                                          info
                                      ...
                                      <div className="col-md-12 border-left-style-searchPage">
                                        ...
                                        <div className="row my-1 ">
                                          <div className="col-md-10">
                                            ...
                                            {subjectInfo?.campuses?.map(
                                              (camp) => (
                                                <span className="btn-customStyle-1 ms-2">
                                                  {camp?.campusName}
                                                </span>
                                              )
                                            )}
                              ...
                              {!loadAll ? (
                                <div className="text-center mb-3">
                                  <span
                                    ...
                                    onClick={showAllData}
                                  >
                                    See {info?.subjectCounter - showNum} More
                                    Programs{" "}
                                ...
                                <div className="text-center mb-3">
                                  <span
                                    ...
                                    onClick={collapseALl}
                                  >
                                    Hide {info?.subjectCounter - showNum} More
                                    Programs{" "}
