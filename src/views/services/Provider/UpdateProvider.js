...
const UpdateProvider = () => {
  ...
  const providerLogo = useSelector(
    (state) => state?.GeneralProviderlogoFile.ProviderLogoFile
  );
        ...
        <CardBody>
          <form onSubmit={handleSubmit}>
            ...
            <FormGroup row>
              ...
              <UncontrolledTooltip placement="top" target="nameTooltip">
                Your Name
              </UncontrolledTooltip>
            ...
            <FormGroup row>
              ...
              <UncontrolledTooltip placement="top" target="numberTooltip">
                Your Phone Number
              </UncontrolledTooltip>
            ...
            <FormGroup row>
              <Col md="2">
                <i
                  id="addressLineTooltip"
                  className="fas fa-info-circle menuIcon"
                ></i>
                <span className="pl-2">Address Line </span>
              </Col>

              <UncontrolledTooltip placement="top" target="addressLineTooltip">
                Address Line
              </UncontrolledTooltip>
