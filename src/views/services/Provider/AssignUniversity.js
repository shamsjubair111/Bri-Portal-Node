          ...
          <Row className="mb-3">
            <Col lg="6" md="6" sm="12" xs="12">
              {permissions?.includes(
                permissionList.Add_New_Admission_manager_university
              ) ? (
                <ButtonForFunction
              ...
              <Table id="table-to-xls" className="table-sm table-bordered">
                ...
                <tbody>
                      ...
                      {checkAction ? (
                        <td style={{ width: "8%" }} className="text-center">
                          ...
                          /> */}
                            ...
                            {permissions?.includes(
                              permissionList.Update_Admission_manager_university_info
                            ) ? (
                              <ButtonForFunction
                            ...
                            {permissions?.includes(
                              permissionList.Delete_Admission_manager_university
                            ) ? (
                              <ButtonForFunction
                                color={"danger"}
                  ...
                  >
                    <ModalBody>
                      <p>
                        Are You Sure to Delete this <b>{managerUniName}</b> ?
                    ...
                    <ModalFooter>
                      <Button
                        ...
                        color="danger"
                        onClick={() => handleDeletePermission(managerUniId)}
                      >
