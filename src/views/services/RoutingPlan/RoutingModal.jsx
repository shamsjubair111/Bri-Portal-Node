...
const RoutingModal = ({
  ...
  const [doNotJump, setDoNotJump] = React.useState(false);
  const [disableAnsweringRules, setDisableAnsweringRules] =
    React.useState(false);
  const [skipOverrideFromHeader, setSkipOverrideFromHeader] =
    React.useState(false);
