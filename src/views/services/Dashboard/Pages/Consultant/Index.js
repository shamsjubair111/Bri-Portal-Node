...
const Consultant = () => {
  ...
  // useEffect(() => {
  //   get(`ConsultantDashboard/Counting`).then((res) => {
  //     setCount(res);
  //   });

  //   get(`ConsultantDashboard/Application`).then((res) => {
  //     setApplications(res);
  //   });
  ...
  //   get(`ConsultantDashboard/TargetApplication`).then((res) => {
  //     setTarget(res);
  //   });
                ...
                <CardBody>
                  ...
                  <div className="d-flex justify-content-between">
                    <span
                      onClick={() => {
                        history.push(
                          `/withdrawTransactionByConsultant/${currentUser?.referenceId}`
                        );
                      }}
