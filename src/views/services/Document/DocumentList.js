    ...
    <div>
      {loading ? (
        ...
        <div>
          ...
          <Card>
            <CardHeader>
              {permissions?.includes(permissionList?.Add_New_Document) ? (
                <ButtonForFunction
                        ...
                        <td>
                          <ButtonGroup>
                            {permissions?.includes(
                              permissionList.Update_Document_info
                            ) ? (
                              <ButtonForFunction
                            ...
                            {permissions?.includes(
                              permissionList.Delete_Document
                            ) ? (
                              <ButtonForFunction
                                className={"mx-1 btn-sm"}
                                func={() =>
                          ...
                          >
                            <ModalBody>
                              <p>
                                Are You Sure to Delete this <b>{delDocuName}</b>{" "}
                            ...
                            <ModalFooter>
                              <Button
                                color="danger"
                                onClick={() => handleDeleteDocument(delDocuId)}
