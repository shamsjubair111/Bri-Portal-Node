            ...
            <CardHeader className="page-header">
              ...
              <div className="page-header-back-to-home">
                <span onClick={backToDocumentList} className="text-white">
                  {" "}
                  <i className="fas fa-arrow-circle-left"></i> Back to Document
                  List
                </span>
              </div>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              {permissions?.includes(
                permissionList.Add_New_Document_Category
              ) ? (
                <ButtonForFunction
                  ...
                  <tbody>
                    ...
                    />
                        ...
                        <td>
                          <ButtonGroup>
                            {permissions?.includes(
                              permissionList.Update_Document_Category_info
                            ) ? (
                              <ButtonForFunction
                            ...
                            {permissions?.includes(
                              permissionList.Delete_Document_Category
                            ) ? (
                              <ButtonForFunction
                                className={"mx-1 btn-sm"}
                          ...
                          >
                            <ModalBody>
                              <p>
                                Are You Sure to Delete this <b>{docuName}</b> ?
                            ...
                            <ModalFooter>
                              <Button
                                color="danger"
                                onClick={() => handleDeleteCategory(docuId)}
                                disabled={buttonStatus}
                              >
