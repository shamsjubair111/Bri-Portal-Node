  ...
  return (
    <div>
      ...
      <Card>
        <CardBody>
          <Row className="mb-3">
            <Col lg="6" md="5" sm="6" xs="4"></Col>

            <Col lg="6" md="7" sm="6" xs="8"></Col>
          </Row>
          {siteSettingInfo[0] ? null : (
            ...
            <div>
              ...
              <Form className="mt-5">
                <FormGroup row className="has-icon-left position-relative">
                  ...
                  <Col md="6">
                    <img
                      src={`${rootUrl}${siteSettingInfo[0]?.uappLogoUrl}`}
                      alt="logoImg"
                      className="img-fluid"
                    />
                  </Col>
                ...
                <FormGroup row className="has-icon-left position-relative">
                  ...
                  <Col md="6">
                    <img
                      src={`${rootUrl}${siteSettingInfo[0]?.uappfaviconUrl}`}
                      className="img-fluid"
                      alt="faviconImg"
                    />
                  </Col>
                ...
                <FormGroup row className="has-icon-left position-relative">
                  ...
                  <Col md="6">
                    ...
                    <span>{siteSettingInfo[0]?.connectionStrings}</span>
                  </Col>
                </FormGroup>
                ...
                <FormGroup row className="has-icon-left position-relative">
                  ...
                  <Col md="6">
                    <span className="pe-2">:</span>{" "}
                    <span>{siteSettingInfo[0]?.siteShortName}</span>
                ...
                <FormGroup row className="has-icon-left position-relative">
                  ...
                  <Col md="6">
                    <span className="pe-2">:</span>{" "}
                    <span>{siteSettingInfo[0]?.siteFullName}</span>
                    {/* <div className="form-control-position">
                                        <User size={15} />
                                    </div> */}
                  </Col>
                ...
                <FormGroup row className="has-icon-left position-relative">
                  ...
                  <Col md="6">
                    <span className="pe-2">:</span>
                    <span>{siteSettingInfo[0]?.backupPath}</span>
                  </Col>
                </FormGroup>
