...
const EmployeeGeneralInfo = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    subData.append(
      "coverImage",
      result1.length > 0 ? result1[0]?.originFileObj : null
    );
    ...
    if (titleValue == 0) {
      ...
      setProgress(true);
      axios
        .post(`${rootUrl}Employee/Create`, subData, {
          headers: {
            ...
            <TabPane tabId="1">
              <Form ref={myForm} onSubmit={handleSubmit} className="mt-5">
                ...
                <FormGroup row className="has-icon-left position-relative">
                  ...
                  <Col md="6">
                    <CoverPicturesWall error2={error2} setError2={setError2} />
                ...
                >
                  <Col md="6">
                    <Button
                      color="danger"
                      className="mt-3 mx-2"
                      onClick={() => history.push("/staffList")}
                    >
                      Cancel
                    </Button>
