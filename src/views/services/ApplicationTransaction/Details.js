              ...
              {data?.transactionNote == null ? (
                <>
                  {permissions?.includes(
                    permissionList.Update_Application_transaction_info
                  ) ? (
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="d-flex justify-content-between">
                          {data?.transactionStatusId !== 2 && (
                            <>
                              {permissions?.includes(
                                permissionList.Update_Applicationtransaction_TransactionStatus_info
                              ) ? (
                                <SpanButton
                                  icon={
                                    <i
          ...
          <Card>
            <CardBody>
              ...
              <div className="hedding-titel d-flex justify-content-between mt-4">
                ...
                {permissions?.includes(
                  permissionList?.Update_Application_transaction_installment_info
                ) ? (
                  <>
                    {" "}
