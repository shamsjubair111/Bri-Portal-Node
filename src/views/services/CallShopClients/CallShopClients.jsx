...
import CallShopClientsModal from "./CallShopClientsModal";

const CallShopClients = () => {
      ...
      <CallShopClientsModal
        ...
        title={
          selectedPermissionId
            ? "Update CallShop Client"
            : "Create Callshop Client"
        }
      ...
      <Card>
        <CardBody>
          <div className="border-bottom mb-4">
            <h4 className="pb-3">Callshop clients</h4>
          </div>
          <div className="mt-4 container-fluid">
            <div className="row mb-3">
              <div className="col-md-4">
                <h6>Find Callshop Client : </h6>
...
export default CallShopClients;
